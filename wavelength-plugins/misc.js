...
exports.commands = {
	...
	credits: function (target, room, user) {
		let popup = "|html|" + "<font size=5 color=#0066ff><u><b>Surge Credits</b></u></font><br />" +
			"<br />" +
	...
	wlssbhelp: ["/ssb (staffmon name) - Gives details on a staffmon from SSB."],
	...
	usercodes: function (target, room, user) {
		...
		let keys = Db.userType.keys(), codes = {3: 'Surge Sysop', 4: 'Autoconfirmed', 5: 'Permalocked', 6: 'Permabanned'};
